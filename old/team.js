...
const slideshowImages = [
  ...
  { src: "assets/images/team-images/members/Gadigi-Aditri.jpg", name: "Aditri Gadigi", desc: "Aditri is a freshman Computer Science student pursuing a minor in Statistics. She is currently one of the Modeling co-chairs. After graduation, she plans to pursue computational biology research and development. In her free time, Aditri enjoys watching movies, exploring cities, and playing board games." },
  { src: "assets/images/team-images/members/jonathon-meyer.jpg", name: "Jonathon Meyer", desc: "Jonathon description" },
  { src: "assets/images/team-images/members/IMG_3901.jpg", name: "Sarah Firdaus", desc: "Sarah Firdaus is a junior bioengineering major and creative writing minor. This is her second cycle as a wet lab chair for UMaryland iGEM. In the future, she plans to pursue a career in medicine. Outside of school, she enjoys spending time with friends and family, reading, and community service." },
  { src: "assets/images/team-images/members/Sami_Kudagunti_Headshot.jpg", name: "Sami Kudagunti", desc: "Sami Kudagunti is a freshman bioengineering student on the pre-med track. She hopes to become a physician, and she involves herself with biotech and biomedical research. In iGEM, she is a primary wet lab member and the membership chair. In her free time, she enjoys figure skating, reading, and traveling." },
  { src: "assets/images/team-images/members/Krista-Adu-Osei.jpg", name: "Krista Adu Osei", desc: "Krista description" },
  { src: "assets/images/team-images/members/brennen.jpg", name: "Brennen Le", desc: "Brennen description" },
  { src: "assets/images/team-images/members/patrick.jpg", name: "Patrick Hong", desc: "Patrick description" },
  { src: "assets/images/team-images/members/Vikram Khandelwal Headshot.jpg", name: "Vikram Khandelwal", desc: "Hi! I'm Vikram Khandelwal, a CS+Math major graduating 2025. Currently building toehold validation software, but generally I love applying CS everywhere I go! Aiming to learn more about genetics in the future." },
  { src: "assets/images/team-images/members/Viharika.jpg", name: "Viharika Penmetsa", desc: "Viharika description" },
  { src: "assets/images/team-images/members/Ananya.jpg", name: "Ananya Jagdish", desc: "Ananya description" },
  { src: "assets/images/team-images/members/Patricia Rosemond Headshot.jpg", name: "Patricia Rosemond", desc: "Hi, my name is Patricia Rosemond. I am a biology major with a concentration in physiology and neurobiology. My goals are to get my MD in Obstetrics and PHD in maternal and child health. With IGEM, I help with social media presence and designs. I'm really glad to be a part of this years project." },
  { src: "assets/images/team-images/members/Dana_Harel_Headshot.jpg", name: "Dana Harel", desc: "Hi my name is Dana Harel and I am a sophomore Bioengineering major, and I'm super excited to be working on the Wet Lab and Finance committees this cycle! Long term, I'd like to do more research in tissue engineering and regenerative medicine. When I'm not iGEM-ing or in the library, I love to read, bake, and make jewelry!" },
  { src: "assets/images/team-images/members/Haider Hussain headshot.jpg", name: "Haider Hussain", desc: "Haider Hussain is a pre-med bioengineering major, with a keen interest in cancer biology and oncology. Driven by his desire to translate his knowledge to patient care, he's pursuing a medical career in these fields. As a member of the iGEM modeling committee, he has helped to design methodologies and translate the reaction kinetics into mathematical models for the device." },
  { src: "assets/images/team-images/members/Rebecca Lu Headshot.jpg", name: "Rebecca Lu", desc: "Rebecca is a bioengineering major in the class of 2026. She is interesting in biotechnology and therapeutics and is also minoring in data science. Her goal is to work in the pharmaceuticals industry but more importantly, she wants to be actively involved in the design and creation of technology to contribute to advancements in healthcare. She joined iGEM for its collaborative approach to synthetic biology and is currently in the Wet Lab and Finance committees. Outside of iGEM she loves hanging out with friends, crocheting, and volunteering in the local community through the Biomedical Engineering Society!" },
  { src: "assets/images/team-images/members/Kevin Zhang headshot.jpg", name: "Kevin Zhang", desc: "Kevin Zhang is a sophomore bioengineering major and a prospective CS minor. This is his second cycle as a wet lab member and during his time in iGEM, he has done work with literature review, wet lab, dry lab, and modeling. Long term, he plans to pursue a career in biotech and is currently planning on going to graduate school to earn a Ph.D. Outside of school, he enjoys playing the violin and spending time with friends and family!" },
  { src: "assets/images/team-images/members/Graham Ferguson Headshot.jpg", name: "Graham Ferguson", desc: "Graham Ferguson is a sophomore majoring in Cell Biology and Molecular Genetics and minoring in Paleobiology. His work in iGEM has focused on the wet lab experimental work and the development of our modeling team's procedures and data analysis. He would like to pursue a PhD in Microbiology after his time at UMD and do research using bacteria for wastewater remediation and clean energy production. He thinks bacteria are the coolest domain of life and challenges you to convince him otherwise." },
  { src: "assets/images/team-images/members/sarahz.jpg", name: "Sarah Zachariah", desc: "Sarah description" },
  { src: "assets/images/team-images/members/keithheadshot.jpg", name: "Keith Oliver", desc: "Keith description" },
